...
class ProjectMarginHighTableWidget extends TableWidget
{
    protected static ?int $sort = 62;
    ...
    {
        return $table
            ->heading('Höchste Marge je Projekt')
            ->paginated(false)
    ...
    private function records(): Collection
    {
        ...
        return ProjectServiceDashboardQuery::topProjectsByMargin(8, $pref)
